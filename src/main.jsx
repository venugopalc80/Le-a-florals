    ...
    <div className="site-shell">
      ...
      <header className="nav-wrap">
        ...
        <nav className={menu ? 'nav mobile-open' : 'nav'}>
          <a href="#shop" onClick={closeMenu}>Shop</a><a href="#services" onClick={closeMenu}>Services</a><a href="#work" onClick={closeMenu}>Work</a><a href="#flowerbar" onClick={closeMenu}>Flower Bar</a><a href="#contact" onClick={closeMenu}>Contact</a>
        </nav>
        <div className="nav-actions">
          <button className="pill pill-dark" onClick={() => setOrderOpen(true)}>Order flowers</button>
          <button className="menu-button" aria-label="Toggle menu" onClick={() => setMenu(!menu)}>{menu ? <Icon name="close" size={21}/> : <Icon name="menu" size={21}/>}</button>
        </div>
      </header>

      <main id="top">
        <section className="hero section-pad">
          <div className="hero-copy"><p className="eyebrow">Floral design, thoughtfully composed</p><h1>Flowers with<br/><em>a point of view.</em></h1><p className="hero-text">Seasonal florals, installations and styling for brands, spaces and the moments worth remembering.</p><div className="hero-actions"><a href="#work" className="pill pill-dark">Explore the work <Icon name="arrow" size={15}/></a><a href="#contact" className="text-link">Work with Leïa</a></div></div>
          <div className="hero-image-wrap"><img src="https://images.unsplash.com/photo-1519225421980-715cb0215aed?auto=format&fit=crop&w=1500&q=90" alt="Editorial floral arrangement"/><div className="hero-caption"><span>01</span><span>Made by hand · Manchester</span></div></div>
        </section>
