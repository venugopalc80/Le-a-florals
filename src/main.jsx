...
const worlds = [
  ...
  { no: '02', title: 'Weddings', line: 'Personal flowers. Extraordinary spaces.', image: 'https://images.unsplash.com/photo-1507504031003-b417219a0fde?auto=format&fit=crop&w=1800&q=92' },
...
const flowers = [
  { name: 'Hand-tied', price: 'From £45', image: 'https://images.unsplash.com/photo-1487070183336-b863922373d4?auto=format&fit=crop&w=1200&q=92' },
  ...
  return <div className="site">
    ...
    <main id="top">
      <section className="hero">
        <div className="hero-copy"><span>Floral design studio · Manchester</span><h1>Flowers,<br/><i>with a point<br/>of view.</i></h1><button onClick={()=>document.getElementById('work')?.scrollIntoView({behavior:'smooth'})}>Explore our work <Arrow/></button></div>
        <div className="hero-image"><SafeImage eager src="https://images.unsplash.com/photo-1526047932273-341f2a7631f9?auto=format&fit=crop&w=2200&q=94" alt="Sculptural floral arrangement"/></div>
        <div className="hero-side">People<br/>Places<br/>Ideas<br/><i>in bloom.</i></div><div className="scroll">Scroll <b>↓</b></div>
      </section>

      <section className="approach" id="about"><div className="approach-image"><SafeImage src="https://images.unsplash.com/photo-1494336934272-f7f4ea6cfd77?auto=format&fit=crop&w=1700&q=92" alt="Floral designer working with flowers"/></div><div className="approach-copy"><span>Our approach</span><h2>We don't just<br/><i>arrange flowers.</i></h2><p>We create atmosphere, shape, colour and feeling. From intimate gatherings to global brands, our work is guided by beauty, intention and emotion.</p><a href="#work">Our story <Arrow/></a></div><div className="approach-detail"><span>More than flowers.</span><strong>A feeling.</strong></div></section>
      ...
      <section className="statement"><div className="statement-image"><SafeImage src="https://images.unsplash.com/photo-1527061011665-3652c757a4d4?auto=format&fit=crop&w=1900&q=92" alt="Floral installation"/></div><div className="statement-copy"><span>Floral direction</span><h2>For a more<br/><i>beautiful world.</i></h2><p>We collaborate with people and brands who believe in the power of flowers to transform spaces, tell stories and create lasting impressions.</p><a href="#contact">Our approach <Arrow/></a></div><blockquote>“Flowers change<br/>how we see<br/>the world.”<small>— Leïa</small></blockquote></section>

      <section className="flowerbar" id="flowerbar"><div className="flowerbar-copy"><span>05 · Flower Bar · FIA Coffeehouse</span><h2>The<br/><i>Flower Bar.</i></h2><p className="script">flowers<br/>coffee<br/>good people</p><p>Fresh flowers. Great coffee. A space to slow down, connect and take something beautiful with you.</p><a href="mailto:Hello@Leiaflorals.co.uk?subject=Flower%20Bar">Visit the Flower Bar <Arrow/></a></div><div className="flowerbar-image"><SafeImage src="https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=1800&q=92" alt="Coffee and flowers in a cafe"/></div></section>
      ...
      <section className="final" id="contact"><div className="final-flower"><SafeImage src="https://images.unsplash.com/photo-1490750967868-88aa4486c946?auto=format&fit=crop&w=1200&q=92" alt="Single flower"/></div><div className="final-copy"><span>Have a brief?</span><h2>Let's make<br/><i>something memorable.</i></h2><p>Weddings · Brands · Events · Flowers</p><button onClick={()=>enquire('Project enquiry')}>Enquire now <Arrow/></button></div></section>
    </main>

    <footer><div className="footer-logo">LEÏA<small>Floral design studio · Manchester, UK</small></div><div><span>Explore</span><a href="#work">Work</a><a href="#weddings">Weddings</a><a href="#events">Events</a><a href="#flowerbar">Flower Bar</a></div><div><span>Connect</span><a href="#flowers">Flowers</a><a href="#about">About</a><a href="#contact">Contact</a><a href="https://www.instagram.com/leiaflorals/" target="_blank" rel="noreferrer">Instagram</a></div><div className="footer-end">Flowers, with a point of view.<br/><br/>© 2026 Leïa Florals</div></footer>

    {open&&<div className="modal" onClick={()=>setOpen(false)}><div className="modal-card" onClick={e=>e.stopPropagation()}><button className="close" onClick={()=>setOpen(false)}><Close/></button><span>Leïa Florals · Enquiry</span><h2>Let's make<br/><i>something beautiful.</i></h2><p>Tell us a little about what you have in mind. We will reply with availability and next steps.</p><form onSubmit={submit}><input name="name" placeholder="Your name" required/><input name="email" type="email" placeholder="Email address" required/><select name="enquiry" defaultValue={selected}><option>{selected}</option><option>Flowers / order</option><option>Wedding enquiry</option><option>Events enquiry</option><option>Brands / editorial</option><option>General enquiry</option></select><input name="date" placeholder="Preferred date (optional)"/><textarea name="details" rows="5" placeholder="Tell us about the occasion, style, location, budget or anything else..."></textarea><button className="submit" type="submit">Send enquiry <Arrow/></button></form></div></div>}
  </div>
}
