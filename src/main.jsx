...
function SafeImage({ src, alt }) {
  ...
  return <div className={`safe-image ${failed ? 'is-fallback' : ''}`} role="img" aria-label={alt}>{!failed && <img src={src} alt={alt} loading="lazy" onError={() => setFailed(true)} />}{failed && <div className="fallback-art" aria-hidden="true"><span>Leïa</span><i></i><b></b><em></em></div>}</div>;
}
